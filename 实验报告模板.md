...
- 步骤 5：功能验证
  ...
  - 输出/结果（截图/日志）：
  - <img width="865" height="505" alt="image" src="https://github.com/user-attachments/assets/522a2acc-2e15-4490-a5cf-f2cb7e667377" />
    <img width="865" height="401" alt="image" src="https://github.com/user-attachments/assets/8a107460-b091-43bf-9e34-333e94d8da96" />
#### 6.3 关键配置文件（如有）
贴出核心配置片段并解释字段含义。
**Dockerfile.base文件**
...
- **验证用例列表**（输入/操作 -> 预期 -> 实际结果）：
  - 用例1：访问 http://localhost:8081/ → 返回应用信息 ✓
    <img width="1233" height="72" alt="3d1bf89fbbb5d959f57ba28257010037" src="https://github.com/user-attachments/assets/a4d9dc86-2ec4-40f0-b435-c19bb3c14da6" />
  - 用例2：访问 http://localhost:8082/env → 显示环境变量 ✓
  ...
  - 用例3：访问 http://localhost:8083/info → 显示系统信息 ✓
